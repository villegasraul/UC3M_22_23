...
if (!require('pacman')) install.packages('pacman'); library('pacman') ## El ; sirve para poner dos líneas de código en una mismsa
...
# Te quita todos los caracteres especiales, te añade barras bajas, te quita tildes... de todas las columnas
# Es del paquete janitor
...
# Hay algunas veces que no hace falta recodificar de uno en uno. Aquí me puedo cargar muchas recodificaciones de golpe
